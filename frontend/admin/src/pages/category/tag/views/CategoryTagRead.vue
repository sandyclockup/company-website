    ...
    <section class="content">
        ...
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">
                    <i class="fas fa-search"></i>&nbsp;Category Tag Details
                </h3>
            </div>
            <div class="card-body">
               <div class="clearfix">
                ...
                <div class="clearfix">
                    <div class="float-left">
                     ...
                     <div :class="!loading ? 'float-right' : 'float-right d-none'">
                        <router-link to="/category/tag/create" data-toggle="tooltip" title="Back To List" class="btn  btn-success">
                            <i class="fas fa-plus mr-2"></i>Create New
                        </router-link>
                        &nbsp;
                        <router-link :to="'/category/tag/edit/'+category.id" data-toggle="tooltip" title="Edit Data" class="btn  btn-info">
            ...
            deleteData(){
               ...
               Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        this.$store.dispatch("categoryTag/delete", id).then(() => {
                            Swal.fire(
                                'Delete Success',
                                'Your item has been deleted!',
                                'success'
                            )
                            this.$router.push("/category/tag/list");
                        })
                    }
                });
            }
