    ...
    <section class="content">
        ...
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">
                    <i class="fas fa-edit"></i>&nbsp;Form Category Portfolio
                </h3>
            </div>
    ...
    export default {
        ...
        methods: {
            ...
            formSubmit(data){
                ...
                this.loading = true;
                this.$store.dispatch("categoryPortfolio/update", { id, data }).then((result) => {
                    this.loading = false;
                    this.message = result.message;
                    Swal.fire('Success', this.message, 'success');
                    this.$router.push("/category/portfolio/read/"+result.data.id);
                },
                (error) => {
                    this.loading = false;
                    this.message =
