                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10 input-form">
                            <Field name="icon" v-model="feature.icon" v-slot="{ field, errors }">
                    ...
                    <div class="form-group row">
                        <label class="col-sm-2 col-form-label">Title<span class="text-danger">*</span></label>
                            <div class="col-sm-10 input-form">
                              <Field name="title" v-model="feature.title" v-slot="{ field, errors }">
                                <input v-bind="field" type="text" :readonly="loading" :class="errors.length == 0 ? 'form-control' : 'form-control is-invalid'">
                            </Field>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10 input-form">
                            <Field name="description" v-model="feature.description" v-slot="{ field, errors }">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10 input-form">
                             <Field name="sort" v-model="feature.sort" v-slot="{ field, errors }">
    ...
    export default {
        ...
        methods: {
            ...
            formSubmit(data){
                ...
                this.loading = true;
                this.$store.dispatch("feature/update", { id, data }).then((result) => {
                    this.loading = false;
        ...
        mounted() {
            ...
            this.$store.dispatch("feature/read", this.$route.params.id).then((result) => {
                ...
                this.optionValue = this.feature.is_published;
