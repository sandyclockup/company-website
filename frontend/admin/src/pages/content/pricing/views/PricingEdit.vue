                ...
                <div class="card-body">
                   ...
                   <div class="form-group row">
                        ...
                        <div class="col-sm-10 input-form">
                            <Field name="name" v-model="pricing.name"  v-slot="{ field, errors }">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10 input-form">
                             <Field name="price" v-model="pricing.price" v-slot="{ field, errors }">
                     ...
                     <div class="form-group row">
                        ...
                        <div class="col-sm-10 input-form">
                            <Field name="unit" v-model="pricing.unit" v-slot="{ field, errors }">
                                <input v-bind="field" type="text" :readonly="loading" :class="errors.length == 0 ? 'form-control' : 'form-control is-invalid'">
                            </Field>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10 input-form">
                           <Field name="link" v-model="pricing.link" v-slot="{ field, errors }">
                                <input v-bind="field" type="text" :readonly="loading" :class="errors.length == 0 ? 'form-control' : 'form-control is-invalid'">
                            </Field>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10 input-form">
                            <Field name="description" v-slot="{ field }">
                                <ckeditor :editor="editor" v-bind="field" v-model="pricing.description" :readonly="loading"   :config="editorConfig"></ckeditor>
                            </Field>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10 input-form">
                             <Field name="sort" v-model="pricing.sort" v-slot="{ field, errors }">
                                <input v-bind="field" type="number" :readonly="loading" :class="errors.length == 0 ? 'form-control' : 'form-control is-invalid'">
                            </Field>
    ...
    export default {
        ...
        methods: {
            ...
            formSubmit(data){
                ...
                this.loading = true;
                this.$store.dispatch("pricing/update", { id, data }).then((result) => {
                    this.loading = false;
        ...
        mounted() {
            ...
            this.$store.dispatch("pricing/read", this.$route.params.id).then((result) => {
                ...
                this.optionValue = this.pricing.is_published;
                this.recomended = this.pricing.is_recomended;
                this.advanced = this.pricing.is_advanced;
                this.pricing.price = Number(this.pricing.price).toFixed(2);
                $("#"+this.select2_id).val(this.optionValue).trigger('change');
                $("#"+this.recomended_id).val(this.recomended).trigger('change');
                $("#"+this.advanced_id).val(this.advanced).trigger('change');
            },
            (error) => {
                this.loading = false;
                this.message =
