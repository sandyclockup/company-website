            ...
            <div class="card-header">
               <div class="clearfix">
                    <div class="float-left">
                        <h3 class="card-title">
                            <i class="fas fa-table"></i>&nbsp;List Article
                        </h3>
                    </div>
                    <div class="float-right">
                        <router-link to="/content/article/create" class="btn btn-success">
    ...
    export default {
        ...
        methods:{
            ...
            onRead(e){
                e.preventDefault();
                let id = e.target.getAttribute('data-id');
                this.$router.push("/content/article/read/"+id);
                return false;
            },
            onDelete(e){
              e.preventDefault();
        ...
        mounted() {
            ...
            let option = {
                ...
                "fetch_url": process.env.VUE_APP_BACKEND_URL+"/cms/content/article",
            }
                ...
                },
                {
                    ...
                    render: function (data) {
                        if(!data){
                            ...
                            let imageUpload = process.env.VUE_APP_BACKEND_URL+"/files/"+data
                            return `<img src="`+imageUpload+`" alt='Image' class='img img-responsive img-thumbnail' width='80' />`;
                        }
