            ...
            <div class="card-header">
               <div class="clearfix">
                    <div class="float-left">
                        <h3 class="card-title">
                            <i class="fas fa-table"></i>&nbsp;List FAQ
                        </h3>
                    </div>
                    <div class="float-right">
                        <router-link to="/content/faq/create" class="btn btn-success">
    ...
    export default {
        ...
        methods:{
            onEdit(e){
                ...
                this.$router.push("/content/faq/edit/"+id);
                return false;
            },
            onRead(e){
                e.preventDefault();
                let id = e.target.getAttribute('data-id');
                this.$router.push("/content/faq/read/"+id);
                return false;
            },
            onDelete(e){
              e.preventDefault();
        ...
        mounted() {
            ...
            let option = {
                ...
                "fetch_url": process.env.VUE_APP_BACKEND_URL+"/cms/content/faq",
            }
