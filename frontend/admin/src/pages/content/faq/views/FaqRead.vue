            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item">
                            <router-link to="/content/faq/list">FAQ</router-link>
                        </li>
                    ...
                    <table class="table table-striped">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td v-else>
                                    <span :class="faq.is_published === 1 ? 'badge bg-success' : 'badge bg-danger'">
                                        {{ faq.is_published === 1 ? 'Published' : 'Draft' }}
                                    </span>
                                </td>
                            </tr>
                        </tbody>
            ...
            <div class="card-footer">
                <div class="clearfix">
                    <div class="float-left">
                        <router-link to="/content/faq/list" data-toggle="tooltip" title="Back To List"
                            class="btn  btn-secondary">
                            <i class="fas fa-arrow-left mr-2"></i>Back To List
                        </router-link>
                    </div>
                    <div :class="!loading ? 'float-right' : 'float-right d-none'">
                        <router-link to="/content/faq/create" data-toggle="tooltip" title="Back To List"
                            class="btn  btn-success">
                            <i class="fas fa-plus mr-2"></i>Create New
                        </router-link>
                        &nbsp;
                        <router-link :to="'/content/faq/edit/'+faq.id" data-toggle="tooltip" title="Edit Data"
                            class="btn  btn-info">
            ...
            deleteData() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        this.$store.dispatch("faq/delete", id).then(() => {
                            Swal.fire(
                                'Delete Success',
                                'Your item has been deleted!',
                                'success'
                            )
                            this.$router.push("/content/faq/list");
                        })
                    }
                });
            }
