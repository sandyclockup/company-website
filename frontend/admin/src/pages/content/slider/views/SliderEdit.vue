            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><router-link to="/content/slider/list">Slider</router-link></li>
    ...
    <section class="content">
        ...
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">
                    <i class="fas fa-edit"></i>&nbsp;Form Slider
                </h3>
            </div>
            <Form  @submit="handSubmit" :validation-schema="schema" class="form-horizontal">
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10 input-form">
                            <Field name="title" v-model="slider.title"  v-slot="{ field, errors }">
                     ...
                     <div class="form-group row">
                        ...
                        <div class="col-sm-10 input-form">
                            <Field name="link" v-model="slider.link" type="text" class="form-control"></Field>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10 input-form">
                            <Field name="description" v-model="slider.description" v-slot="{ field, errors }">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10 input-form">
                            <Field name="sort" v-model="slider.sort" v-slot="{ field, errors }">
                ...
                <div class="card-footer">
                     <div class="clearfix">
                        <div class="float-left">
                           <router-link to="/content/slider/list" data-toggle="tooltip" title="Back To List" class="btn  btn-secondary">
    ...
    export default {
        ...
        data () {
            const schema = yup.object().shape({
                ...
                description: yup.string().min(5, "Must be minumum 5 characters!").required("Description is required!"),
       ...
       methods: {
            ...
            formSubmit(data){
                ...
                this.loading = true;
                this.$store.dispatch("slider/update", { id, data }).then((result) => {
                    this.loading = false;
                    this.message = result.message;
                    Swal.fire('Success', this.message, 'success');
                    this.$router.push("/content/slider/read/"+result.data.id);
                },
                (error) => {
                    this.loading = false;
                    this.message =
        ...
        mounted() {
            ...
            this.$store.dispatch("slider/read", this.$route.params.id).then((result) => {
                    ...
                    this.optionValue = this.slider.is_published;
                    if(this.slider.image){
                        this.imagePreview = process.env.VUE_APP_BACKEND_URL+"/files/"+this.slider.image;
                        this.fileImage = "";
                    }
