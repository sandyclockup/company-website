            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><router-link to="/content/skill/list">Skill</router-link></li>
    ...
    <section class="content">
        ...
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">
                    <i class="fas fa-edit"></i>&nbsp;Form Skill
                </h3>
            </div>
            <Form  @submit="handSubmit" :validation-schema="schema" class="form-horizontal">
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        <label class="col-sm-2 col-form-label">Name<span class="text-danger">*</span></label>
                            <div class="col-sm-10 input-form">
                              <Field name="name" v-model="skill.name" v-slot="{ field, errors }">
                    ...
                    <div class="form-group row">
                        <label class="col-sm-2 col-form-label">Index Ratio<span class="text-danger">*</span></label>
                            <div class="col-sm-10 input-form">
                              <Field name="index_ratio" v-model="skill.index_ratio" v-slot="{ field, errors }">
                                <input v-bind="field" type="number" :readonly="loading" :class="errors.length == 0 ? 'form-control' : 'form-control is-invalid'">
                            </Field>
                            <ErrorMessage name="index_ratio" class="error invalid-feedback" />
                        </div>
                    </div>
                     ...
                     <div class="form-group row">
                        ...
                        <div class="col-sm-10 input-form">
                            <Field name="description" v-model="skill.description" v-slot="{ field, errors }">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10 input-form">
                             <Field name="sort" v-model="skill.sort"  v-slot="{ field, errors }">
                                <input v-bind="field" type="number" :readonly="loading" :class="errors.length == 0 ? 'form-control' : 'form-control is-invalid'">
                            </Field>
                ...
                <div class="card-footer">
                     <div class="clearfix">
                        <div class="float-left">
                           <router-link to="/content/skill/list" data-toggle="tooltip" title="Back To List" class="btn  btn-secondary">
    ...
    export default {
         ...
         data () {
            const schema = yup.object().shape({
                ...
                index_ratio: yup.string().required("Index Ratio is required!"),
        ...
        methods: {
            ...
            formSubmit(data){
                ...
                this.loading = true;
                this.$store.dispatch("skill/update", { id, data }).then((result) => {
                    this.loading = false;
                    this.message = result.message;
                    Swal.fire('Success', this.message, 'success');
                    this.$router.push("/content/skill/read/"+result.data.id);
                },
                (error) => {
                    this.loading = false;
                    this.message =
        ...
        mounted() {
            document.title = "Skill | " + process.env.VUE_APP_TITLE
            let app = this;
            ...
            this.$store.dispatch("skill/read", this.$route.params.id).then((result) => {
                this.skill = result.data;
                this.optionValue = this.skill.is_published;
                this.skill.index_ratio = Number(this.skill.index_ratio).toFixed(2);
