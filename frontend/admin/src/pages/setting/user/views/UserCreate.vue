            ...
            <Form  @submit="handleOnSubmit" :validation-schema="schema" class="form-horizontal">
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10 input-form">
                            <Field name="password"  v-slot="{ field, errors }">
                                <input v-bind="field" type="password" :readonly="loading" :class="errors.length == 0 ? 'form-control' : 'form-control is-invalid'">
                            </Field>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10 input-form">
                            <Field name="nick_name"  v-slot="{ field }">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10 input-form">
                            <Field name="full_name"  v-slot="{ field }">
                                <input v-bind="field" type="text" :readonly="loading"  class="form-control">
                            </Field>
                        </div> 
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10 input-form">
                            <Field name="facebook"  v-slot="{ field }">
                                <input v-bind="field" type="text" :readonly="loading"  class="form-control">
                            </Field>
                        </div> 
                    </div>
    ...
    export default {
        ...
        methods: {
            ...
            formSubmit(data){
                ...
                this.loading = true;
                this.$store.dispatch("user/create", data).then((result) => {
                    this.loading = false;
                    this.message = result.message;
                    Swal.fire('Success', this.message, 'success');
                    this.$router.push("/setting/user/read/"+result.data.user.id);
                },
                (error) => {
                    this.loading = false;
                    this.message =
