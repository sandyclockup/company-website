            ...
            <div class="card-header">
               <div class="clearfix">
                    <div class="float-left">
                        <h3 class="card-title">
                            <i class="fas fa-table"></i>&nbsp;List User
                        </h3>
                    </div>
                    <div class="float-right">
                        <router-link to="/setting/user/create" class="btn btn-success">
    ...
    export default {
        ...
        mounted() {
            ...
            let option = {
                ...
                "fetch_url": process.env.VUE_APP_BACKEND_URL+"/setting/user",
            }
            ...
            let columns = [
                ...
                },
                {
                    ...
                    render: function (data) {
                        return parseInt(data) === 1 ? `<span class="badge bg-info">Admin</span>` : `<span class="badge bg-primary">Guest</span>`;
                    }
                },
                {
                    data: 'is_banned',
                    className: "text-center",
                    render: function (data) {
                        return parseInt(data) === 1 ? `<span class="badge bg-danger">Yes</span>` : `<span class="badge bg-success">No</span>`;
                    }
                },
                {
                    data: 'verified',
                    className: "text-center",
                    render: function (data) {
                        return parseInt(data) === 1 ? `<span class="badge bg-success">Confirmed</span>` : `<span class="badge bg-danger">Wating Confirmed</span>`;
                    }
                },
                {
                    data: 'id',
