            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><router-link to="/reference/service/list">Service</router-link></li>
    ...
    <section class="content">
        ...
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">
                    <i class="fas fa-edit"></i>&nbsp;Form Service
                </h3>
            </div>
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10 input-form">
                            <Field name="icon" v-model="service.icon" v-slot="{ field, errors }">
                    ...
                    <div class="form-group row">
                        <label class="col-sm-2 col-form-label">Title<span class="text-danger">*</span></label>
                            <div class="col-sm-10 input-form">
                              <Field name="title"  v-model="service.title"  v-slot="{ field, errors }">
                                <input v-bind="field" type="text" :readonly="loading" :class="errors.length == 0 ? 'form-control' : 'form-control is-invalid'">
                            </Field>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10 input-form">
                            <Field name="description"  v-model="service.description" v-slot="{ field, errors }">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10 input-form">
                             <Field name="sort"  v-model="service.sort"  v-slot="{ field, errors }">
                ...
                <div class="card-footer">
                     <div class="clearfix">
                        <div class="float-left">
                           <router-link to="/reference/service/list" data-toggle="tooltip" title="Back To List" class="btn  btn-secondary">
    ...
    export default {
        ...
        methods: {
            ...
            formSubmit(data){
                ...
                this.loading = true;
                this.$store.dispatch("serve/update", { id, data }).then((result) => {
                    this.loading = false;
                    this.message = result.message;
                    Swal.fire('Success', this.message, 'success');
                    this.$router.push("/reference/service/read/"+result.data.id);
                },
                (error) => {
                    this.loading = false;
                    this.message =
        ...
        mounted() {
            ...
            this.$store.dispatch("serve/read", this.$route.params.id).then((result) => {
                this.service = result.data;
                this.optionValue = this.service.is_published;
