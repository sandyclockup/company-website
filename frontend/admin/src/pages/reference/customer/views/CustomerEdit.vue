            ...
            <Form  @submit="handSubmit" :validation-schema="schema" class="form-horizontal">
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10 input-form">
                            <Field name="name" v-model="customer.name"  v-slot="{ field, errors }">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10 input-form">
                            <Field name="email" v-model="customer.email"  v-slot="{ field, errors }">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10 input-form">
                            <Field name="phone" v-model="customer.phone" v-slot="{ field, errors }">
                                <input v-bind="field" type="text"  :readonly="loading" :class="errors.length == 0 ? 'form-control' : 'form-control is-invalid'">
                            </Field>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10 input-form">
                            <Field name="address" v-model="customer.address" v-slot="{ field, errors }">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10 input-form">
                            <select :readonly="loading" :id="select2_id"  class="form-control">
                                ...
                                <option v-for="row in options" :key="row.value" :selected="row.value === optionValue" :value="row.value">{{ row.text }}</option>
                            </select>
                ...
                <div class="card-footer">
                     <div class="clearfix">
                        ...
                        <div class="float-right">
                            ...
                            &nbsp;
                            <button type="submit" class="btn btn-success" :disabled="loading || !customer">
                                <span v-if="loading">
    ...
    export default {
        ...
        methods: {
            ...
            formSubmit(data){
                ...
                this.loading = true;
                this.$store.dispatch("customer/update", { id, data }).then((result) => {
                    this.loading = false;
        ...
        mounted() {
            ...
            this.$store.dispatch("customer/read", this.$route.params.id).then((result) => {
                ...
                this.optionValue = this.customer.is_published;
                if(this.customer.image){
                    this.imagePreview = process.env.VUE_APP_BACKEND_URL+"/files/"+this.customer.image;
                    this.fileImage = "";
                }
