            ...
            <div class="card-header">
               <div class="clearfix">
                    ...
                    <div class="float-right">
                        <router-link to="/reference/customer/create" class="btn btn-success">
    ...
    export default {
        ...
        methods:{
            onEdit(e){
                ...
                this.$router.push("/reference/customer/edit/"+id);
                return false;
            },
            onRead(e){
                e.preventDefault();
                let id = e.target.getAttribute('data-id');
                this.$router.push("/reference/customer/read/"+id);
                return false;
            },
            onDelete(e){
              e.preventDefault();
        ...
        mounted() {
            ...
            let option = {
                ...
                "fetch_url": process.env.VUE_APP_BACKEND_URL+"/cms/reference/customer",
            }
