                   ...
                   <table class="table table-striped">
                       <tbody>
                            <tr>
                                ...
                                <td v-else>
                                    <span v-if="team.image">
                                        <img :src="team.image" class="img-thumbnail" width="200" />
                                    </span>
                                    <span v-else>
                            ...
                            <tr>
                                ...
                                <td v-else>
                                    <span :class="team.is_published === 1 ? 'badge bg-success' : 'badge bg-danger'">
                                        {{ team.is_published === 1 ? 'Published' : 'Draft' }}
                                    </span>
                                </td>
                            </tr>
                       </tbody>
            ...
            <div class="card-footer">
                <div class="clearfix">
                    ...
                    <div :class="!loading ? 'float-right' : 'float-right d-none'">
                        <router-link to="/reference/team/create" data-toggle="tooltip" title="Back To List" class="btn  btn-success">
                            <i class="fas fa-plus mr-2"></i>Create New
                        </router-link>
                        &nbsp;
                        <router-link :to="'/reference/team/edit/'+team.id" data-toggle="tooltip" title="Edit Data" class="btn  btn-info">
               ...
               Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        this.$store.dispatch("team/delete", id).then(() => {
                            ...
                            this.$router.push("/reference/team/list");
                        })
                    }
                });
            }
