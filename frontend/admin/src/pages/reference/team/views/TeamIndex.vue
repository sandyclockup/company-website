            ...
            <div class="card-header">
               <div class="clearfix">
                    <div class="float-left">
                        <h3 class="card-title">
                            <i class="fas fa-table"></i>&nbsp;List Team
                        </h3>
                    </div>
                    <div class="float-right">
                        <router-link to="/reference/team/create" class="btn btn-success">
...
<script>
    ...
    export default {
        data(){
            return {
                table_id: uuidv4(),
                imageUser: process.env.VUE_APP_BASE_URL+"/img/no-image.png",
            }
        },
        methods:{
            onEdit(e){
                ...
                this.$router.push("/reference/team/edit/"+id);
                return false;
            },
            onRead(e){
                e.preventDefault();
                let id = e.target.getAttribute('data-id');
                this.$router.push("/reference/team/read/"+id);
                return false;
            },
            onDelete(e){
              e.preventDefault();
              ...
              Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        this.$store.dispatch("team/delete", id).then(() => {
                            Swal.fire(
                                'Delete Success',
        ...
        mounted() {
            ...
            let option = {
                ...
                "fetch_url": process.env.VUE_APP_BACKEND_URL+"/cms/reference/team",
            }
            ...
            let columns = [
                ...
                },
                {
                    ...
                    render: function (data) {
                        if(!data){
                            return `<img src="`+app.imageUser+`" alt='Image' class='img img-responsive img-thumbnail' width='80' />`;
                        }else{
                            let imagePerson = process.env.VUE_APP_BACKEND_URL+"/files/"+data
                            return `<img src="`+imagePerson+`" alt='Image' class='img img-responsive img-thumbnail' width='80' />`;
                        }
