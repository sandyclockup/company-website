                    ...
                    <table class="table table-striped">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td v-else>
                                    <span
                                        :class="portfolio.is_published === 1 ? 'badge bg-success' : 'badge bg-danger'">
                                        {{ portfolio.is_published === 1 ? 'Published' : 'Draft' }}
                                    </span>
                                </td>
                            </tr>
                        </tbody>
            ...
            <div class="card-footer">
                <div class="clearfix">
                    ...
                    <div :class="!loading ? 'float-right' : 'float-right d-none'">
                        <router-link to="/reference/portfolio/create" data-toggle="tooltip" title="Back To List"
                            class="btn  btn-success">
                            <i class="fas fa-plus mr-2"></i>Create New
                        </router-link>
                        &nbsp;
                        <router-link :to="'/reference/portfolio/edit/'+portfolio.id" data-toggle="tooltip"
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        this.$store.dispatch("serve/delete", id).then(() => {
                            ...
                            this.$router.push("/reference/portfolio/list");
                        })
                    }
                });
            }
